...
namespace Netsy.UI.ViewModels
{
    ...
    public class FeedbacksViewModel : BaseViewModel
    {
        ...
        /// </summary>
        private readonly ObservableCollection<FeedbacksViewModel> items = new ObservableCollection<FeedbacksViewModel>();
        ...
        /// Gets the Items 
        /// </summary>
        public ObservableCollection<FeedbacksViewModel> Items
        {
