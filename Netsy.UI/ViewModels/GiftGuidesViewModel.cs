//-----------------------------------------------------------------------
// <copyright file="FeedbacksViewModel.cs" company="AFS">
...
namespace Netsy.UI.ViewModels
{
    ...
    /// </summary>
    public class GiftGuidesViewModel : BaseViewModel
    {
        /// <summary>
        /// the listings shown on the gui
        /// </summary>
        private readonly ObservableCollection<GiftGuideViewModel> items = new ObservableCollection<GiftGuideViewModel>();
        ...
        /// Gets the Items 
        /// </summary>
        public ObservableCollection<GiftGuideViewModel> Items
        {
