...
namespace Netsy.UI.ViewModels
{
    ...
    /// <summary>
    /// View model for Front items
    /// </summary>
    public class ListingsViewModel : BaseViewModel
    {
        /// <summary>
        /// the items shown on the gui
        /// </summary>
        private readonly ObservableCollection<ListingViewModel> items = new ObservableCollection<ListingViewModel>();
        ...
        /// Gets the Items 
        /// </summary>
        public ObservableCollection<ListingViewModel> Items
        {
